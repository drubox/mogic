...
<form action="index.php" method="POST">
  <label for="max-width"> Body max-width (px) (0 for no max-width): </label><br />
  <input name="max-width" id="max-width" value="<?php print $max_width; ?>" /><br />
  <label for="min-width"> Body min-width (px) (0 for no min-width): </label><br />
  <input name="min-width" id="min-width" value="<?php print $min_width; ?>" /><br />
  ...
  <label for="device-width"> Device (can be 1024 for <em>g_x_1024</em>, mobile for <em>g_x_mobile</em>, m for <em>g_x_m</em>, ...): </label><br />
  ...
  <label for="margin">Margin between cols (px)</label><br />
